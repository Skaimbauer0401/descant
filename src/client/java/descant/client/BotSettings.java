...
import descant.client.settings.DoubleSetting;
import descant.client.settings.EnumSetting;
import descant.client.settings.IntSetting;
import descant.client.settings.SettingRegistry;
import descant.client.settings.SettingRegistry.Tier;
import descant.client.settings.StringSetting;
 ...
 * that can be changed while the game runs, by {@code /descant set} or by a model.</p>
 *
...
public final class BotSettings {
	 ...
	 *
	 * <p>Applied only when placing is allowed. When it is not — {@code /descant walk}, or having run out
	...
	public static final IntSetting AI_RECALL = new IntSetting("aiRecall", 6, 0, 20,
			"How many recent lines of descant and AI chat a new AI run is shown, so a follow-up like "
	...
	/**
	 * Where {@code /descant chest} looks when it is not told.
	 *
	 ...
	 * cell — see {@link descant.client.path.WorldView#isHalfSupport}.
	 *
