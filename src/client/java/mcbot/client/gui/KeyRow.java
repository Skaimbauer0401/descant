 ...
 *
 * <p>The key goes into {@code config/mcbot-keys.properties} — never into a setting. That rule has not
 * moved: settings are listed by {@code /mcbot set}, echoed into chat and written into the action
