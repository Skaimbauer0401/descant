 ...
 * menu whereas discovering an unbound key takes knowing it exists. {@code /mcbot config} opens the
 ...
 */
public final class McbotKeys {

	private static final KeyMapping SETTINGS = new KeyMapping("key.mcbot.settings",
